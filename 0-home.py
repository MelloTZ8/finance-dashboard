...
with st.sidebar:
    ...
    st.page_link("pages/3-placeholder.py", label="[04] Inflation 🚧")
    st.page_link("pages/4-placeholder.py", label="[05] Metals 🚧")
    st.page_link("pages/5-placeholder.py", label="[06] Energy 🚧")
    st.page_link("pages/6-placeholder.py", label="[07] Global Markets 🚧")
    st.page_link("pages/7-placeholder.py", label="[08] Sectors 🚧")
    st.page_link("pages/8-placeholder.py", label="[09] Positioning 🚧")
    st.page_link("pages/9-placeholder.py", label="[10] Options Flow 🚧")
    st.page_link("pages/10-placeholder.py", label="[11] Options Analyzer 🚧")
    st.page_link("pages/11-placeholder.py", label="[12] Liquidity 🚧")
